...
/**
 * token_type should be sent in the url to get access_token from LinkedIn. So we need to intercept
 * the request and add token_type parameter before calling linkedin..
 *
 * @author Tamil
 */
public class OAuth2AccessTokenResponseConverterWithDefaults
  ...
  public OAuth2AccessTokenResponse convert(Map<String, String> tokenResponseParameters) {
    ...
    // original tokenResponseParameters (from linkedin code response) doesn't contain token type.
    // set it here before requesting access token
