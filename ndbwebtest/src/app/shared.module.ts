...
@NgModule(
  {
    ...
    declarations: [StateListComponent, StateDropDownComponent, DistrictListComponent, AddPersonComponent, CityDropdownComponent, LoginComponent],
    exports: [StateListComponent, StateDropDownComponent, DistrictListComponent, AddPersonComponent, CityDropdownComponent, LoginComponent],
    providers: []
  }
)
