# awsndb serverless API
The awsndb project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=awsndb -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3 -DgroupId=com.success -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd awsndb
$ mvn clean package
