...
public final class Constants {
	...
	private static final String[] SPRING_SECURITY_ALLOWED_URLS = new String[]{
			"/v2/api-docs", "/swagger-resources/configuration/ui",
			"/swagger-resources", "/swagger-resources/configuration/security",
			"/swagger-ui.html", "/webjars/**", "/user-register", "/login",
			"/get-token", "/refresh-token", "/logout-me", "/ping", "/add-user"};
