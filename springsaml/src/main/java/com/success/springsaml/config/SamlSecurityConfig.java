package com.success.springsaml.config;
...
import com.success.springsaml.service.SAMLUserDetailsServiceImpl;
...
public class SamlSecurityConfig extends WebSecurityConfigurerAdapter
  ...
  public KeyManager keyManager() {
    ...
    String storePass = "test123";
    String storeDefaultKey = "newton";
    Map<String, String> passwords = new HashMap<>();
    passwords.put(storeDefaultKey, storePass);
    return new JKSKeyManager(storeFile, storePass, passwords, storeDefaultKey);
    */
	  DefaultResourceLoader loader = new DefaultResourceLoader();
      Resource storeFile = loader
              .getResource("classpath:/saml/samlKeystore.jks");
      String storePass = "test123";//jks store password
      Map<String, String> passwords = new HashMap<String, String>();
      passwords.put("pkey", "test123"); //private key alias and its corresponding password
      String defaultKey = "pkey";//private key alias
  ...
  public MetadataGenerator metadataGenerator() {
    ...
    metadataGenerator.setEntityId("com:success:spring:saml:trocks:sp");
